...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    ...
    @Query("select new com.scss.jobcoordi.dto.RoleContentDto(c.role, c.content) from ChatMessage c where c.uuid = :uuid order by c.chatId desc")
    List<RoleContentDto> findRecentMessagesByUuid(String uuid, Pageable pageable);
